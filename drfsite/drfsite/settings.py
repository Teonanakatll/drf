...
SECRET_KEY = 'django-insecure-2ugyen(j(414vzcpn7w^8(k$74p-+7p1^*43!6ov2f2rb0o-3_'
...
SIMPLE_JWT = {
    ...
    # Определяет заголовок перед токеном в заголовке запроса
    "AUTH_HEADER_TYPES": ("Bearer",),
    "AUTH_HEADER_NAME": "HTTP_AUTHORIZATION",
    # id пользователя будет определяться user_id (внутри токена)
    "USER_ID_FIELD": "id",
